"""
Django settings for towdaddy_41119 project.
...
ROOT_URLCONF = 'towdaddy_41119.urls'
...
WSGI_APPLICATION = 'towdaddy_41119.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "towdaddy_41119 API",
    "DESCRIPTION": "API documentation for towdaddy_41119 App",
    "VERSION": "v1",
}
